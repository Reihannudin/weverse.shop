        ...
        <>
            ...
            <div className="pt-14">
                {product.map((item) => {
                    return(
                        <>
                            <ViewProductComponent id={item.id} max_buy={item.max_buy} image={item.image} name={item.name} price={item.price} status={item.status} shipment_status={item.shipment_status} shipment_estimate={item.shipment_estimate} />
